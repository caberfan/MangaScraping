...
BASE = "https://dilib.vn/truyen-tranh/tho-san-hunter-x-hunter-15833-chap-{}.html"
...
for chap in range(413, 431):
    ...
    try:
        ...
        for img in soup.find_all("img"):
            ...
            if src and src.startswith("/img/comic/Hunter.x.Hunter/"):
        ...
        folder = f"Hunter_x_Hunter/Chương {chap:03}"
