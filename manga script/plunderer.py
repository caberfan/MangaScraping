...
BASE = "https://dilib.vn/truyen-tranh/kich-truy-vuong-huyen-thoai-14761-chap-{}.html"
...
for chap in range(1, 184):
    ...
    try:
        ...
        for img in soup.find_all("img"):
            ...
            if src and src.startswith("/img/comic/Kich-Truy-Vuong-Huyen-Thoai/"):
        ...
        folder = f"Plunderer/Chương {chap:03}"
