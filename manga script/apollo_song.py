...
BASE = "https://dilib.vn/truyen-tranh/bai-hat-cua-apollo-apollos-song-15840-chap-{}.html"
...
for chap in range(1, 27):
    ...
    try:
        ...
        for img in soup.find_all("img"):
            ...
            if src and src.startswith("/img/comic/Apollos.Song/"):
        ...
        folder = f"Apollos_Song/Chương {chap:03}"
