...
BASE = "https://dilib.vn/truyen-tranh/bac-si-quai-di-black-jack-14726-chap-{}.html"
...
for chap in range(1, 219):
    ...
    try:
        ...
        for img in soup.find_all("img"):
            ...
            if src and src.startswith("/img/comic/Bac-Si-Quai-Di/"):
        ...
        folder = f"Black Jack/Chương {chap:03}"
