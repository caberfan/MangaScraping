...
BASE = "https://dilib.vn/truyen-tranh/ninja-loan-thi-14796-chap-{}.html"
...
for chap in range(351, 409):
    ...
    try:
        ...
        for img in soup.find_all("img"):
            ...
            if src and src.startswith("/img/comic/Ninja-Loan-Thi/"):
        ...
        folder = f"Ninja_Rantaro/Chương {chap:03}"
