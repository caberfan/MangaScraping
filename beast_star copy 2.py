...
BASE = "https://dilib.vn/truyen-tranh/boi-vi-chung-ta-deu-la-nhung-ngoi-sao-beastars-5688-chap-{}.html"
...
for chap in range(1, 216):
    ...
    try:
        ...
        for img in soup.find_all("img"):
            ...
            if src and src.startswith("/img/comic/Beastars/"):
        ...
        folder = f"Beastars/Chương {chap:03}"
