...
BASE = "https://dilib.vn/truyen-tranh/thay-giao-vi-dai-onizuka-gto-14802-chap-{}.html"
...
for chap in range(1, 209):
    ...
    try:
        ...
        for img in soup.find_all("img"):
            ...
            if src and src.startswith("/img/comic/GTO/"):
