...
BASE = "https://dilib.vn/truyen-tranh/lang-khach-vagabond-5566-chap-{}.html"
...
for chap in range(323, 360):
    ...
    try:
        ...
        for img in soup.find_all("img"):
            ...
            if src and src.startswith("/img/comic/Vagabond/"):
        ...
        folder = f"Vagabond/Chương {chap:03}"
